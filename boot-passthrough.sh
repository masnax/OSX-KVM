...
#  -device vfio-pci,host=01:00.0,multifunction=on
 ...
 # -device vfio-pci,host=03:00.0,bus=pcie.0
  -device vfio-pci,host=0000:00:02.0,id=hostdev0,bus=pcie.0,addr=0x2,romfile="/home/max/git/OSX_GVT-D/i915ovmf/i915ovmf.rom"
  #-fw_cfg name=etc/igd-opregion,file="/home/max/git/OSX_GVT-D/i915ovmf/opregion.bin"
  #-fw_cfg name=etc/igd-bdsm-size,file="/home/max/git/OSX_GVT-D/i915ovmf/bdsmSize.bin"
	#,romfile=i915ovmf.rom
  -device isa-applesmc,osk="ourhardworkbythesewordsguardedpleasedontsteal(c)AppleComputerInc"
  -drive if=pflash,format=raw,readonly,file="/home/max/git/OSX_GVT-D/OVMF/OVMF_CODE.fd"
  -drive if=pflash,format=raw,file="/home/max/git/OSX_GVT-D/OVMF/OVMF_VARS-1024x768.fd"
  -smbios type=2
  -device ich9-intel-hda -device hda-duplex
  -device ich9-ahci,id=sata
  -drive id=OpenCoreBoot,if=none,snapshot=on,format=qcow2,file="$REPO_PATH/OpenCore/OpenCore.qcow2"
  -device ide-hd,bus=sata.2,drive=OpenCoreBoot
  -drive id=MacHDD,if=none,file="/home/max/KVM/macOS/hackintosh_hd.img",format=qcow2
