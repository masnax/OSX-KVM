...
args=(
  ...
  -drive id=OpenCoreBoot,if=none,snapshot=on,format=qcow2,file="$REPO_PATH/OpenCore/OpenCore-smaller.qcow2"
  ...
  #-netdev tap,id=net0,ifname=tap0,script=no,downscript=no -device vmxnet3,netdev=net0,id=net0,mac=52:54:00:c9:18:27
	-netdev user,id=net0,hostfwd=tcp::15922-:5900,hostfwd=tcp::12222-:22,hostfwd=tcp::14022-:4000
  -monitor stdio
